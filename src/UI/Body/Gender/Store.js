...
export const Store = {
  men: {
    ...
    Clothes: [
      [GreyBrownShirt, "Grey Brown Shirt", "20", "12"],
      [GreyRusticLinen, "Grey Rustic Linen", "40", "10"],
      [GreyTShirt, "Grey Tshirt", "45", "34"],
      [longsleevedTshirt, "Long Sleeved Tshirt", "75", "5"],
      [RedPlainLong, "Red Plain Long", "50", "11"],
      [sepiaBrownSuit, "Sepia Brown Suit", "65", "7"],
      [whiteHoodie, "White Hoodie", "10", "8"],
      [BlackHoodie, "Black Hoodie", "58", "10"],
      [BlueLongsleeveTshirt, "Blue Longsleeve", "90", "45"],
    ],
    Furniture: [
      [Bedroom, "Bedroom", "120", "15"],
      [BarberChair, "Barber Chair", "10", "24"],
      [chair, "Chair", "10", "12"],
      [Dinningtable, "Dinning Table", "", "25"],
    ],
    Electronics: [
      [digitalclock, "Digital Clock", "", "10"],
      [DjSpeaker, "Dj Speaker", "45", "9"],
      [GameController, "Game Controller", "23", "12"],
      [Headphone, "Headphone", "12", "19"],
      [Loudspeaker, "LoudSpeaker", "35", "30"],
    ],
    Shoes: [
      [sneakers, "Sneakers", "45", "15"],
      [timberland, "Timberland", "34", "7"],
      [shoe1, "Shoe", "45", "12"],
      [shoeflash, "Shoe sleek", "34", "23"],
    ],
  },
  women: {
    Fashion: "Women",
    ...
    Clothes: [
      [Navyandwhite, "Navy and White", "40", "14"],
      [wnavyBlue, "Navy Blue", "55", "10"],
      [wnavysuit, "Navy Suit", "47", "24"],
      [skirt, "Skirt", "12", "14"],
      [wpolo, "Polo", "32", "10"],
    ],
    Bags: [
      [sunMountain, "Sun Mountain", "45", "16"],
      [blackDior, "Black Dior", "55", "34"],
      [cartierBag, "Cartier Bag", "45", "23"],
      [whitebag, "White Bag", "35", "15"],
      [shoulderbag, "Shoulder", "25", "7"],
      [nikeGym, "Nike GymBag", "50", "15"],
    ],
    Shoes: [
      [blackShoe, "Black Shoe", "15", "10"],
      [candycane, "Candy Cane", "24", "13"],
      [livewireride, "LiveWire Ride", "23", "12"],
      [TonyBiancoBrazen, "Tony Bianco", "55", "34"],
      [winterFashion, "Winter Fashion", "45", "15"],
    ],
    Jewelry: [[silverware, "SilverWare", "15", "12"]],
  },
  ...
  kids: {
    ...
    Clothes: [
      [Blackgown, "Black Gown", "18", "5"],
      [DreamSleepSuit, "Dream Sleep Suit", "7", "15"],
      [LikeABossCamouflage, "Boss Camouflage", "22", "20"],
      [ny, "Newyork", "10", "10"],
      [rompersuit, "RomperSuit", "20", "14"],
      [cartoon, "Cartoon", "45", "9"],
    ],
    Toys: [
      [assortmentkidstoys, "Assortment Toys", "", "14"],
      [babytoy, "Baby Toy", "30", "14"],
      [fishercornpopper, "Corn Popper", "45", "10"],
      [girafeehead, "Girafee Head", "19", "18"],
      [leapfrogspin, "Leap Frog Spin", "60", "19"],
      [playingtoys, "Playing Toys", "45", "22"],
      [polyTurtle, "Poly Turtle", "20", "10"],
      [toysTop, "Toys Top", "120", "11"],
      [toytrain, "Train", "230", "20"],
      [toyvector, "Toys Vector", "110", "33"],
    ],
  },
};
