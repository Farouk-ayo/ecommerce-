...
export const Store = {
  men: {
    ...
    Clothes: [
      [GreyBrownShirt, "Grey Brown Shirt", "20", "12", "1"],
      [GreyRusticLinen, "Grey Rustic Linen", "40", "10", "2"],
      [GreyTShirt, "Grey Tshirt", "45", "34"],
      [longsleevedTshirt, "Long Sleeved Tshirt", "75", "5", "3"],
      [RedPlainLong, "Red Plain Long", "50", "11", "4"],
      [sepiaBrownSuit, "Sepia Brown Suit", "65", "7", "5"],
      [whiteHoodie, "White Hoodie", "10", "8", "6"],
      [BlackHoodie, "Black Hoodie", "58", "10", "7"],
      [BlueLongsleeveTshirt, "Blue Longsleeve", "90", "45", "7"],
    ],
    Furniture: [
      [Bedroom, "Bedroom", "120", "15", "8"],
      [BarberChair, "Barber Chair", "10", "24", "9"],
      [chair, "Chair", "10", "12", "10"],
    ...
    Electronics: [
      ...
      [Loudspeaker, "LoudSpeaker", "35", "30", "15"],
    ],
    Shoes: [
      [sneakers, "Sneakers", "45", "15", "16"],
      [timberland, "Timberland", "34", "7", "17"],
      [shoe1, "Shoe", "45", "12", "18"],
      [shoeflash, "Shoe sleek", "34", "23", "19"],
    ],
  },
  women: {
    Fashion: "Women",
    ...
    Clothes: [
      [Navyandwhite, "Navy and White", "40", "14", "20"],
      [wnavyBlue, "Navy Blue", "55", "10", "21"],
      [wnavysuit, "Navy Suit", "47", "24", "22"],
      [skirt, "Skirt", "12", "14", "23"],
      [wpolo, "Polo", "32", "10", "24"],
    ],
    Bags: [
      [sunMountain, "Sun Mountain", "45", "16", "25"],
      [blackDior, "Black Dior", "55", "34", "26"],
      [cartierBag, "Cartier Bag", "45", "23", "27"],
      [whitebag, "White Bag", "35", "15", "28"],
      [shoulderbag, "Shoulder", "25", "7", "29"],
      [nikeGym, "Nike GymBag", "50", "15", "30"],
    ],
    Shoes: [
      [blackShoe, "Black Shoe", "15", "10", "31"],
      [candycane, "Candy Cane", "24", "13", "32"],
      [livewireride, "LiveWire Ride", "23", "12", "33"],
      [TonyBiancoBrazen, "Tony Bianco", "55", "34", "34"],
      [winterFashion, "Winter Fashion", "45", "15", "35"],
    ],
    Jewelry: [[silverware, "SilverWare", "15", "12", "36"]],
  },
  ...
  kids: {
    ...
    Clothes: [
      [Blackgown, "Black Gown", "18", "5", "37"],
      [DreamSleepSuit, "Dream Sleep Suit", "7", "15", "38"],
      [LikeABossCamouflage, "Boss Camouflage", "22", "20", "39"],
      [ny, "Newyork", "10", "10", "40"],
      [rompersuit, "RomperSuit", "20", "14", "41"],
    ...
    Toys: [
      ...
      [leapfrogspin, "Leap Frog Spin", "60", "19", "47"],
      [playingtoys, "Playing Toys", "45", "22", "48"],
      [polyTurtle, "Poly Turtle", "20", "10", "49"],
      [toysTop, "Toys Top", "120", "11", "50"],
      [toytrain, "Train", "230", "20", "51"],
      [toyvector, "Toys Vector", "110", "33", "52"],
    ],
  },
};
